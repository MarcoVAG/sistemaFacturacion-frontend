...
import UserForm from "../components/usuarios/userForm.js"; // *** DEBES CREAR ESTE COMPONENTE ***
import SearchForm from "../components/usuarios/searchForm.js"; // *** DEBES CREAR ESTE COMPONENTE ***
import UserTable from "../components/usuarios/userTableCrud.js"; // *** VERIFICA LA RUTA SI ES 'crud/userTableCrud.js' o 'userTableCrud.js' ***
      ...
      <div className="card text-center" ref={formRef}>
        ...
        <div className="card-body">
          <UserForm
            ...
            id_rol={id_rol}
            setIdRol={setIdRol}
            listaRoles={listaRoles} // Pasa la lista de roles al formulario
            editarUsuario={editarUsuario}
            handleSubmit={editarUsuario ? edit : add} // Envía la función adecuada
            limpiarCampos={limpiarCampos}
            updatePassword={updatePassword} // Pasa la función para actualizar contraseña
          />
        </div>
        <SearchForm
