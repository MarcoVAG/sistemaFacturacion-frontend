...
import MetodoPagoTable from "../../components/soloLectura/metodosPagoTable.js"; // *** DEBES CREAR ESTE COMPONENTE ***
  ...
  return (
    <div className="container">
      <div className="card text-center" ref={formRef}>
        <div className="card-header">CONSULTA DE MÉTODOS DE PAGO</div>
        <SearchFormMetodos
