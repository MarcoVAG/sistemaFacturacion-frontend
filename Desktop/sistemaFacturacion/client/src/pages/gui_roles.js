  ...
  import RoleForm from "../components/roles/roleForm.js"; // *** DEBES CREAR ESTE COMPONENTE ***
  import SearchForm from "../components/roles/searchForm.js"; // *** DEBES CREAR ESTE COMPONENTE ***
  import RoleTable from "../components/roles/roleTableCrud.js"; // *** DEBES CREAR ESTE COMPONENTE ***
        ...
        <div className="card text-center" ref={formRef}>
          ...
          <div className="card-body">
            <RoleForm
              ...
              editarRol={editarRol}
              handleSubmit={editarRol ? edit : add} // Envía la función adecuada según si es edición o adición
